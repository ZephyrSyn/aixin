    ...
    init: function () {
        ...
        if (i !== -1) {
            S.UI.simulate(decodeURI(action).substring(i + 3));
             ...
             S.UI.simulate('#circle|亲爱的|桂花姐姐|现在是|北京时间|#time|祝亲爱的|圣诞快乐|每天都能|开开心心|#countdown 5|#show', 3000);
...
function show() {
    window.location.href = "https://zephyrsyn.github.io/SL/tt/surprise.html";
}
